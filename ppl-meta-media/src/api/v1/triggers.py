                    ...
                    for device_uuid_str in device_ids:
                        try:
                            ...
                            if device:
                                ...
                                # Note: transition_mode and fade_duration_ms are stored in trigger
                                # but current PlaybackParameters doesn't support them yet
                                # The Android app should handle playlist transitions
                                ...
                                logger.info(f"        📤 Sending START command with playlist {trigger.signage_playlist_id}")
