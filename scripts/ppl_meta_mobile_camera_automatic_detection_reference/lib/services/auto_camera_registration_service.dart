...
import 'network_auto_discovery_service.dart';

/// Service for automatic camera registration
class AutoCameraRegistrationService {
  final NetworkAutoDiscoveryService _networkService = NetworkAutoDiscoveryService();
  ...
  Future<CameraRegistrationResult> autoRegisterCamera({
    ...
    try {
      ...
      final deviceIP = await _networkService.getDeviceIPForRegistration();
