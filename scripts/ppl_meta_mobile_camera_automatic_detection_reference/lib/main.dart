...
import 'features/camera/screens/automatic_camera_setup_screen.dart';
import 'features/streaming/screens/auto_streaming_screen.dart';
import 'screens/automatic_streaming_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer<AuthenticationProvider>(
      builder: (context, authProvider, child) {
        // Always show the new automatic camera setup workflow first
        // This replaces the complex authentication/registration flow  
        return const AutomaticCameraSetupScreen();
      },
    );
  }
}
