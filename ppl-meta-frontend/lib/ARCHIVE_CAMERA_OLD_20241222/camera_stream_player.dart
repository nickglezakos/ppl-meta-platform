...
class _CameraStreamPlayerState extends ConsumerState<CameraStreamPlayer> {
  ...
  Future<String?> _prepareAuthenticatedUrl() async {
    print('✅✅✅ [CAMERA_STREAM_PLAYER] _prepareAuthenticatedUrl called for: ${widget.cameraId} ✅✅✅');
    print('✅ [VERIFY] This is camera_stream_player.dart (NOT simple version)');
    ...
    try {
      ...
      print('📹 [CAMERA_STREAM_PLAYER] Creating streaming session for camera ${widget.cameraId} with device ID: $deviceId');
