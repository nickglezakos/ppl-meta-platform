...
from src.api.v1.endpoints.edge_management import router as edge_management_router
...
v1_router.include_router(edge_management_router, tags=["Edge Camera Management"])
