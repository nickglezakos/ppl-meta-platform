...
class ServiceDiscovery:
    ...
    def get_service_url(self, service_name: str) -> Optional[str]:
        ...
        service_map = {
            ...
            "orchestrator": os.getenv("PPL_ORCHESTRATOR_URL", "http://ppl-meta-orchestrator:8002")
        }
        return service_map.get(service_name)
    
    def make_internal_request(self, service_name: str, endpoint: str, method: str = "GET", **kwargs):
