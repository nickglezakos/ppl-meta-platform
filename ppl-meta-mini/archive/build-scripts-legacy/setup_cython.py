"""
Setup script for Cython compilation of PPL Meta Mini
"""
...
python_files = []
# Exclude patterns - files with FastAPI objects incompatible with Cython
exclude_patterns = [
...
setup(
    name="ppl-meta-mini",
    version="1.1.0",
    description=("PPL Meta Mini - Standalone Face Analytics Service (Cython Compiled)"),
    ...
    install_requires=[
        ...
        # "dlib>=19.24.2",  # Temporarily disabled due to CMake compatibility
    ],
    classifiers=[
