...
assert 'id="shellCurrentRole"' in admin_html
assert 'id="shellCurrentEmail"' in admin_html
assert 'id="shellCurrentDistributorScope"' in admin_html
assert 'id="shellCurrentResellerScope"' in admin_html
assert 'id="overviewCurrentRole"' in admin_html
assert 'id="overviewCurrentEmail"' in admin_html
assert 'id="overviewCurrentDistributorScope"' in admin_html
assert 'id="overviewCurrentResellerScope"' in admin_html
assert 'id="adminCurrentRole"' in admin_html
assert 'id="adminCurrentEmail"' in admin_html
assert 'id="adminCurrentDistributorScope"' in admin_html
assert 'id="adminCurrentResellerScope"' in admin_html
